...
# Create chart button
chart_button1 = tk.Button(frame1, text="ASL Chart", command=lambda: show_chart("C:/Users/akswn/Downloads/Multilingual-Sign-Language-Recognizer-master/Multilingual-Sign-Language-Recognizer-master/Charts/ASL_CHART.png"), width=10, height=2)
...
# Create chart button
chart_button2 = tk.Button(frame2, text="ISL Chart", command=lambda: show_chart("C:/Users/akswn/Downloads/Multilingual-Sign-Language-Recognizer-master/Multilingual-Sign-Language-Recognizer-master/Charts/ISL_CHART.jpg"), width=10, height=2)
